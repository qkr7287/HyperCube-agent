...
import type { WorkspaceQuotaConfig, SystemMetrics } from "../types/index.js";
...
export async function collectSystemMetrics(
  ...
  const [load, cpu, mem, disk, netIfaces, netStats, netConns, dockerInfo, procs, logins, gpu, quota] =
    await Promise.all([
      si.currentLoad(),
      si.cpu(),
      si.mem(),
      ...
      workspaceQuota ? collectWorkspaceQuotaInfo(workspaceQuota).catch(() => null) : Promise.resolve(null),
    ]);
